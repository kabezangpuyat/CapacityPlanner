    ...
    window.history && window.history.pushState && $(window).on("popstate", function () {
        var t = window.location.href; - 1 == t.indexOf("#") && (r.addClass("spa-loader"), $.ajax({
            ...
            success: function (t, o, e) {
                r.removeClass("spa-loader"), r.html(t)
            },
            error: function (t, o, e) {
                r.removeClass("spa-loader"), "error" == o && alert(t)
            }
        }))
        ...
        (n = null == n ? r : $(n)).addClass("spa-loader"), "post" == o.toLowerCase() ? $.ajax({
            ...
            contentType: !1,
            success: function (t, o, e) {
                n.removeClass("spa-loader"), null != l.attr("eval") || (n == r && (a = e.getResponseHeader("Location")) != window.location.href.toString().split(window.location.host)[1] && window.history.pushState(null, null, a), n.html(t))
            },
            error: function (t, o, e) {
                n.removeClass("spa-loader"), n.html(t), "error" == o && alert(t)
            }
        }) : $.ajax({
            type: o,
            url: a + "?" + l.serialize(),
        ...
        (n = null == n ? r : $(n)).addClass("spa-loader"), $.ajax({
            ...
            error: function (t, o, e) {
                n.removeClass("spa-loader"), "error" == o && alert(t), window.history.pushState(null, null, a)
            }
        }), t.preventDefault()
    })
};