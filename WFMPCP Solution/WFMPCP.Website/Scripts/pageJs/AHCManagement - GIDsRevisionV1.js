var ahcManagement_ = {
    ...
    InitializeGridInput: function(){
        ...
        $.each(datearray, function (i) {
        	...
        	//07.03.2018 From txt_7 to txt_101
            $('#txt_101' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_101' + datearray[i]);
            });
			...
			//TODO: PCP Update
            $('#txt_119' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_119' + datearray[i]);
            });
            $('#txt_120' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_120' + datearray[i]);
            });
            $('#txt_121' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_121' + datearray[i]);
            });
            $('#txt_122' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_122' + datearray[i]);
            });
            $('#txt_123' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_123' + datearray[i]);
            });
            $('#txt_124' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_124' + datearray[i]);
            });
            $('#txt_125' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_125' + datearray[i]);
            });
            $('#txt_126' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_126' + datearray[i]);
            });
            $('#txt_127' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_127' + datearray[i]);
            });
            $('#txt_128' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_128' + datearray[i]);
            });
            $('#txt_129' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_129' + datearray[i]);
            });
            $('#txt_130' + datearray[i]).on('keypress keyup blur', function (event) {
            	common.AllowInt(event, '#txt_130' + datearray[i]);
            });
        });
    ...
    */
    ...
    ComputeProduction: function (date) {
    	var production = parseFloat($('#txt_131' + date).val().trim()) + parseFloat($('#txt_132' + date).val().trim());
    	//$('#txt_80' + date).val(production);
    	$('#txt_82' + date).val(production);
    },
    ComputeNewCapacityHireScaleupsAndAttritionClassBackfill: function (date) {
		...
		//07.03.2018
    	//productionTotal = parseFloat($('#txt_82' + date).val().trim()) + (parseFloat($('#txt_94' + date).val().trim()) / 100);
        if ($('#txt_82' + date).val().trim() != '' && $('#txt_94' + date).val().trim() != '')
        	productionTotal = parseFloat($('#txt_82' + date).val().trim()) * (1 - (parseFloat($('#txt_94' + date).val().trim()) / 100));

            $('#txt_13' + date).val($('#txt_82' + date).val().trim());//Production HC
            $('#txt_70' + date).val(productionTotal);//Production Total
            ...
            var hcWeek3Nesting = 0;
            var hcWeek2Nesting = 0;
            var hcWeek1Nesting = 0;
            var newCapacityHireScaleUps = 0;
            var attritionBackfill = 0;
            var plannedfulltimeprodHC = 0;
            var plannedparttimeprodHC = 0;

    	//****************
		//Compute NewCapacityHireScaleUps &  AttritionBackFill
    	//****************
            var txt139Formula = 0;
            if ($('#txt_127' + date).val().trim() != '' && $('#txt_102' + date).val().trim() != '')
            	txt139Formula = parseFloat($('#txt_127' + date).val().trim()) * (1 - (parseFloat($('#txt_102' + date).val().trim()) / 100));

            var txt140Formula = 0;
            if ($('#txt_128' + date).val().trim() != '' && $('#txt_102' + date).val().trim() != '')
            	txt140Formula = parseFloat($('#txt_128' + date).val().trim()) * (1 - (parseFloat($('#txt_102' + date).val().trim()) / 100));

            newCapacityHireScaleUps = txt139Formula + txt140Formula;
            $('#txt_92' + date).val(newCapacityHireScaleUps.toFixed(2));

            var txt141Formula = 0;
            if ($('#txt_129' + date).val().trim() != '' && $('#txt_102' + date).val().trim() != '')
            	txt141Formula = parseFloat($('#txt_129' + date).val().trim()) * (1 - (parseFloat($('#txt_102' + date).val().trim()) / 100));

            var txt142Formula = 0;
            if ($('#txt_130' + date).val().trim() != '' && $('#txt_102' + date).val().trim() != '')
            	txt142Formula = parseFloat($('#txt_130' + date).val().trim()) * (1 - (parseFloat($('#txt_102' + date).val().trim()) / 100));

            attritionBackfill = txt141Formula + txt142Formula;
            $('#txt_93' + date).val(attritionBackfill.toFixed(2));
    	//****************
    	//END
    	//****************
            a = newCapacityHireScaleUps.toFixed(2);
            b = attritionBackfill.toFixed(2);
            ...
            newhireclasses =parseFloat( a ) + parseFloat( b );

		    //07.03.2018
            //trainingTotal = newhireclasses * (parseFloat($('#txt_102' + date).val().trim()) / 100);
            trainingTotal = parseFloat($('#txt_86' + date).val().trim()) * (1 - (parseFloat($('#txt_102' + date).val().trim()) / 100));
		    
            var txt133Formula = 0;
            if ($('#txt_121' + date).val().trim() != '' && $('#txt_98' + date).val().trim() != '')
            	txt133Formula = parseFloat($('#txt_121' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));

            var txt136Formula = 0;
            if ($('#txt_124' + date).val().trim() != '' && $('#txt_98' + date).val().trim() != '')
            	txt136Formula = parseFloat($('#txt_124' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));

            hcWeek3Nesting = txt133Formula + txt136Formula;

            var txt134Formula = 0;
            if ($('#txt_122' + date).val().trim() != '' && $('#txt_98' + date).val().trim() != '')
            	txt134Formula = parseFloat($('#txt_122' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));

            var txt137Formula = 0;
            if ($('#txt_125' + date).val().trim() != '' && $('#txt_98' + date).val().trim() != '')
            	txt137Formula = parseFloat($('#txt_125' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));

            hcWeek2Nesting = txt134Formula + txt137Formula;

            var txt135Formula = 0;
            if ($('#txt_123' + date).val().trim() != '' && $('#txt_98' + date).val().trim() != '')
            	txt135Formula = parseFloat($('#txt_123' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));

            var txt138Formula = 0;
            if ($('#txt_126' + date).val().trim() != '' && $('#txt_98' + date).val().trim() != '')
            	txt138Formula = parseFloat($('#txt_126' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));

            hcWeek1Nesting = txt135Formula + txt138Formula;

            $('#txt_15' + date).val(newhireclasses);//Training HC
            $('#txt_72' + date).val(trainingTotal);//Training Total
            $('#txt_83' + date).val(hcWeek3Nesting.toFixed(2));//Week 3- Nesting
            $('#txt_84' + date).val(hcWeek2Nesting.toFixed(2));//Week 2 - Nesting
            $('#txt_85' + date).val(hcWeek1Nesting.toFixed(2));//Week 1 - Nesting
            ...
            if (isNaN(week3Nesting) || !isFinite(week3Nesting))
            	week3Nesting = 0;

            //revised computation for nesting total as of 02 May 2018
            //nestingTotal = (parseFloat($('#txt_83' + date).val().trim()) + parseFloat($('#txt_84' + date).val().trim()) + parseFloat($('#txt_85' + date).val().trim())) * ((parseFloat($('#txt_83' + date).val().trim())/100));
    		//07.03.2018
            nestingTotal = parseFloat($('#txt_81' + date).val().trim()) * (1 - (parseFloat($('#txt_98' + date).val().trim()) / 100));
            if (isNaN(nestingTotal) || !isFinite(nestingTotal))
            	nestingTotal = 0;

            $('#txt_81' + date).val(week3Nesting);//Nesting - Site
            $('#txt_71' + date).val(nestingTotal);//Nesting Total
            ...
            site1 = txt_80 + parseFloat(week3Nesting) + parseFloat(newhireclasses);
		...
		// New Datapoint 
    	//*************
            if ($('#txt_119' + date).val().trim() != '' && $('#txt_94' + date).val().trim() != '')
            	plannedfulltimeprodHC = parseFloat($('#txt_119' + date).val().trim()) * (1 - (parseFloat($('#txt_94' + date).val().trim()) / 100));

    	//actualProdAttrition is the value of txt_95
            if ($('#txt_120' + date).val().trim() != '')
            	plannedparttimeprodHC = parseFloat($('#txt_120' + date).val().trim()) * (1 - (parseFloat(actualProdAttrition.toFixed(2)) / 100));
		
            $('#txt_131' + date).val(plannedfulltimeprodHC.toFixed(2));
            $('#txt_132' + date).val(plannedparttimeprodHC.toFixed(2));
            $('#txt_133' + date).val(txt133Formula.toFixed(2));
            $('#txt_134' + date).val(txt134Formula.toFixed(2));
            $('#txt_135' + date).val(txt135Formula.toFixed(2));
            $('#txt_136' + date).val(txt136Formula.toFixed(2));
            $('#txt_137' + date).val(txt137Formula.toFixed(2));
            $('#txt_138' + date).val(txt138Formula.toFixed(2));
            $('#txt_139' + date).val(txt139Formula.toFixed(2));
            $('#txt_140' + date).val(txt140Formula.toFixed(2));
            $('#txt_141' + date).val(txt141Formula.toFixed(2));
            $('#txt_142' + date).val(txt142Formula.toFixed(2));
    ...
    OnKeyup: function () {
        ...
        $.each(datearray, function (i) {
        	$('#txt_82' + datearray[i]).bind('propertychange change keyup paste input', function () {
        		ahcManagement.ComputeProduction(datearray[i]);
			...
			//07.03.2018 From txt_7 to txt_101 
            $('#txt_101' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	//Current Support HC
            	$('#txt_16' + datearray[i]).val($('#txt_101' + datearray[i]).val().trim());
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.CascadeHorizontalDynamic(datearray[i], '#txt_101');
            });
			...
			//New textboxes as of 07.03.2018
            $('#txt_119' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_120' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_121' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_122' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_123' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_124' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_125' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_126' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_127' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_128' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_129' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
            $('#txt_130' + datearray[i]).bind('propertychange change keyup paste input', function () {
            	ahcManagement.ComputeProduction(datearray[i]);
            	ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
            });
        });
