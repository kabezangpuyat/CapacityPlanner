var ahcManagement = {
	...
	InitializeGridInput: function () {
		...
		$.each(datearray, function (i) {
			...
			$('#txt_70' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_70' + datearray[i]);
			});
			$('#txt_71' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_71' + datearray[i]);
			});
			$('#txt_72' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_72' + datearray[i]);
			});
			...
			$('#txt_133' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_133' + datearray[i]);
			});
			$('#txt_134' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_134' + datearray[i]);
			});
			$('#txt_135' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_135' + datearray[i]);
			});
			$('#txt_136' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_136' + datearray[i]);
			});
			$('#txt_137' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_137' + datearray[i]);
			});
			$('#txt_138' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_138' + datearray[i]);
			});
			$('#txt_139' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_139' + datearray[i]);
			});
			$('#txt_140' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_140' + datearray[i]);
			});
			$('#txt_141' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_141' + datearray[i]);
			});
			$('#txt_142' + datearray[i]).on('keypress keyup blur', function (event) {
				common.AllowInt(event, '#txt_142' + datearray[i]);
			});
		});
	},
	Initialize: function () {
    ...
    */
	...
	ComputeNewCapacityHireScaleupsAndAttritionClassBackfill: function (date) {
		...
		//$('#txt_70' + date).val(productionTotal);//Production Total **NOTE: changed to Inputted
		...
		if ($('#txt_133' + date).val().trim() != '')
			txt_133 = parseInt($('#txt_133' + date).val().trim());
		if ($('#txt_134' + date).val().trim() != '')
			txt_134 = parseInt($('#txt_134' + date).val().trim());
		if ($('#txt_135' + date).val().trim() != '')
			txt_135 = parseInt($('#txt_135' + date).val().trim());
		if ($('#txt_136' + date).val().trim() != '')
			txt_136 = parseInt($('#txt_136' + date).val().trim());
		if ($('#txt_137' + date).val().trim() != '')
			txt_137 = parseInt($('#txt_137' + date).val().trim());
		if ($('#txt_138' + date).val().trim() != '')
			txt_138 = parseInt($('#txt_138' + date).val().trim());
		if ($('#txt_139' + date).val().trim() != '')
			txt_139 = parseInt($('#txt_139' + date).val().trim());
		if ($('#txt_140' + date).val().trim() != '')
			txt_140 = parseInt($('#txt_140' + date).val().trim());
		if ($('#txt_141' + date).val().trim() != '')
			txt_141 = parseInt($('#txt_141' + date).val().trim());
		if ($('#txt_142' + date).val().trim() != '')
			txt_142 = parseInt($('#txt_142' + date).val().trim());

		$('#txt_92' + date).val((txt_139 + txt_140)); //Planned New Capacity Hire / Scale ups - Full Time + Planned New Capacity Hire / Scale ups - Part Time
		if ($('#txt_92' + date).val().trim() != '')
			a = parseFloat($('#txt_92' + date).val().trim());

		$('#txt_93' + date).val((txt_141 + txt_142));//Planned Attrition / Backfill - Full Time + Planned Attrition / Backfill - Part Time
		...
		week3Nesting = txt_133 + txt_136;

		$('#txt_83' + date).val(week3Nesting);//Week 3- Nesting
		$('#txt_84' + date).val((txt_134 + txt_137));//Week 2 - Nesting
		$('#txt_85' + date).val((txt_135 + txt_138));//Week 1 - Nesting
		...
		//$('#txt_71' + date).val(nestingTotal);//Nesting Total  ** NOTE: CHanged into Inputted
		$('#txt_14' + date).val(week3Nesting);//Nesting HC or ([New Capacity Hire / Scale ups] + [Attrition / Backfill] * 3)

		if ($('#txt_80' + date).val().trim() != '')
			txt_80 = parseFloat($('#txt_80' + date).val().trim());

		site1 = txt_80 + week3Nesting + newhireclasses// txt_80 + txt_81 + txt_86
		$('#txt_79' + date).val(site1);

		if ($('#txt_70' + date).val().trim() != '')
			prodTotal = parseInt($('#txt_70' + date).val().trim());//parseFloat($('#txt_70' + date).val().trim());
		if ($('#txt_71' + date).val().trim() != '')
			nestingTotal = parseInt($('#txt_71' + date).val().trim()); //parseFloat($('#txt_71' + date).val().trim());
		if ($('#txt_72' + date).val().trim() != '')
			trainingTotal = parseInt($('#txt_72' + date).val().trim());//parseFloat($('#txt_72' + date).val().trim());
		...
		if (isNaN(prodNesting) || !isFinite(prodNesting))
			prodNesting = 0;
		$('#txt_69' + date).val(prodNesting);//HEADCOUNT>Overview>Production Total + Nesting Total
		...
		$('#txt_99' + date).val(actualNestingAttrition.toFixed(2) + ' %');//#txt_100 / txt_80
		//*****************************************
		...
		totalSupportCount = actualTLCount + actualYogiCount + actualSMECount;// Actual TL Count + Actual Yogi Count + Actual SME Count
		if (isNaN(totalSupportCount) || !isFinite(totalSupportCount))
			totalSupportCount = 0;
		$('#txt_106' + date).val(totalSupportCount.toFixed(2));//TOTAL SUPPORT COUNT
		$('#txt_16' + date).val(totalSupportCount.toFixed(2));//CURRENT SUPPORT HC
	...
	OnKeyup: function () {
		...
		$.each(datearray, function (i) {
			...
			$('#txt_70' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_70');
				//ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
			});
			$('#txt_71' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_71');
				//ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
			});
			$('#txt_72' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_72');
				//ahcManagement.ComputeNewCapacityHireScaleupsAndAttritionClassBackfill(datearray[i]);
			});
			...
			$('#txt_133' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_133');
			});
			$('#txt_134' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_134');
			});
			$('#txt_135' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_135');
			});
			$('#txt_136' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_136');
			});
			$('#txt_137' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_137');
			});
			$('#txt_138' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_138');
			});
			$('#txt_139' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_139');
			});
			$('#txt_140' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_140');
			});
			$('#txt_141' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_141');
			});
			$('#txt_142' + datearray[i]).bind('propertychange change keyup paste input', function () {
				ahcManagement.CascadeHorizontalNewCapacityHireScaleupsAndAttritionClassBackfillDynamic(datearray[i], '#txt_142');
			});
			...
			$('#txt_7' + datearray[i]).bind('propertychange change keyup paste input', function () {
				//$('#txt_16' + datearray[i]).val($('#txt_7' + datearray[i]).val().trim());//Support HC Old Formula
	...
	ComputeProjectedProductionShrinkage: function (date) {
		...
		var sum = a + b + c + d;//[Projected Production Shrinkage]Breaks+(Coaching + Meeting + Training)+System Down Time+Lost Hours
		...
		var sumOfPlannedUnplanned = unplanned + planned; //Unplanned + Planned
	...
	ComputeShrinkageVariance: function (datearrayvalue, txt_35, txt_44, txt_17, txt_26) {
		...
		$('#txt_53' + datearrayvalue).val(variance.toFixed(2) + ' %');//(Overall Actual Production Shrinkage + Overall Actual Nesting Shrinkage)-(Overall Projected Production Shrinkage + Overall Projected Nesting Shrinkage)
	},
	Save: function (url) {
