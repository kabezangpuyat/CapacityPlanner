...
namespace ExcelService
{
    public class ExcelReader : IDisposable
    {
        ...
        private string ExcelConnectionOptions()
        {
            ...
            return strOpts + "ImportMixedTypes=Text;";
        }
        ...
        private string ExcelConnection()
        {
			...
			//Data Source = C:\_work\WFM_PCP\trunk\docs\WFM PCP Upload - AdoreMe 1.2.30.xls;
			...
			string retValue = @"Provider =Microsoft.Jet.OLEDB.4.0;" +
				@"Data Source=" + _strExcelFilename + ";" +
				@"Extended Properties=" + Convert.ToChar(34).ToString() +
				@"Excel 8.0;" + ExcelConnectionOptions() + Convert.ToChar(34).ToString();

			//string retValue = @"Provider=Microsoft.ACE.OLEDB.12.0;" +
			//	@"Data Source=" + _strExcelFilename + ";" +
			//	@"Extended Properties=" + Convert.ToChar(34).ToString() +
			//	@"Excel 12.0 XML;" + ExcelConnectionOptions() + Convert.ToChar(34).ToString();
        ...
        public void SetValue( string strCell, object objValue )
        {
            ...
            try
            {
                ...
                if ( SetSheetQuerySingelValUpdate( objValue.ToString() ) == false )
                    return;
