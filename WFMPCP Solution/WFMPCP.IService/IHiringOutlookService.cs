...
{
    public interface IHiringOutlookService
    {
        List<OverAllHiringOutlookSummaryViewModel> GetCampaignSummary( DateTime start, DateTime end );
        List<OverAllHiringOutlookSummaryViewModel> GetSiteSummary( DateTime start, DateTime end );
