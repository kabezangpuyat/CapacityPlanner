...
{
    public class WeeklyStaffDatapointMapping : EntityTypeConfiguration<WeeklyStaffDatapoint>
    {
        public WeeklyStaffDatapointMapping()
        {
            this.ToTable( "WeeklyStaffDatapoint" )
                .HasKey( x => x.ID );
            ...
            this.HasOptional( x => x.Site )
                .WithMany( x => x.WeeklyStaffDatapoints )
            ...
            //datapoint mapping
            this.HasRequired( x => x.StaffDatapoint )
                .WithMany( x => x.WeeklyStaffDatapoints )
