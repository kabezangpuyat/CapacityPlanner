...
{
    public class StagingWeeklyDatapointMapping : EntityTypeConfiguration<StagingWeeklyDatapoint>
    {
        public StagingWeeklyDatapointMapping()
        {
            this.ToTable( "StagingWeeklyAHDatapoint" )
                .HasKey( x => x.ID );
