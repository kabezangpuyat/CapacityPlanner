...
{
    public class WeeklySummaryDatapointMapping : EntityTypeConfiguration<WeeklySummaryDatapoint>
    {
        public WeeklySummaryDatapointMapping()
        {
            this.ToTable( "WeeklySummaryDatapoint" )
                .HasKey( x => x.ID );
            ...
            this.HasOptional( x => x.Campaign )
                .WithMany( x => x.WeeklySummaryDatapoints )
            ...
            //datapoint mapping
            this.HasRequired( x => x.SummaryDatapoint )
                .WithMany( x => x.WeeklySummaryDatapoints )
