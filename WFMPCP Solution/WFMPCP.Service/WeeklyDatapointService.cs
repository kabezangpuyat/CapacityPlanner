...
{
	public class WeeklyDatapointService : IWeeklyDatapointService
	{
		...
		{
			var data = _context.AsQueryable<WeeklyDatapoint>()
		...
		#endregion IWeeklyDatapointService
	}
}